...
const jwtSecret = "jhbhfhbBhbyugfbhjbdfhyu"
...
router.post("/loginuser", [body('email', 'Invalid email').isEmail(),body('password','Incorrect Password').isLength({min:5})], async (req, res) => {
